...
const RequestPlasma = ({navigation, route}) =>{ 
    const user = route.params.user;
    const type = "#RequestPlasma"
    ...
    <View>
        ...
        <View style={{alignItems: "center", justifyContent: "center"}}>
            ...
            <View style={{marginVertical: 10, backgroundColor: "#DA1540", paddingVertical: 20, paddingHorizontal:10, borderRadius: 10}}>
            <RNPickerSelect
